...
%
% グローバル変数: beta gamma tran endow rent a1 e1 w1 w2 grid_a a2_nl

global beta gamma tran endow rent ny a1 e1 w1 w2 grid_a a2_nl
...
for i = 1:ny
    ...
    cons = (1 + rent)*a2 + w2*endow(i) - a3_approx;
