...
set(gca,'Fontsize',16);
grid on;
saveas (gcf, 'Fig2_utility_at_period2_TS.eps', 'epsc2');
saveas (gcf, 'Fig2_utility_at_period2_TS.pdf', 'pdf');
...
grid on;
saveas (gcf, 'Fig2_utility_max_TS.eps', 'epsc2');
saveas (gcf, 'Fig2_utility_max_TS.pdf', 'pdf');
...
set(gca, 'Fontsize', 16);
grid on;
saveas (gcf, 'Fig2_pol_discr_TS.eps', 'epsc2');
saveas (gcf, 'Fig2_pol_discr_TS.pdf', 'pdf');
